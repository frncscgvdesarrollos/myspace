...
export default function Home() {
  return (
    <main className="flex lg:flex-row flex-col overflow-x-hidden overflow-y-scroll lg:overflow-hidden w-[90vw] mx-auto h-[100vh]">
      ...
      <div className="flex flex-col w-[100vw] lg:h-[90vh] bg-gray-200 items-start p-4 justify-start lg:overflow-y-scroll overflow-x-hidden  lg:w-[70vw] align-middle flex-col border-l-4 border-red-900">
