  ...
  return (
    <main className="flex lg:flex-row flex-col overflow-x-hidden overflow-y-scroll lg:overflow-hidden w-[90vw] mx-auto h-[100vh]">
      <div className="flex flex-col bg-gray-700 lg:bg-gray-100 justify-start items-center py-4 px-4 border-l-4 border-red-900 lg:w-[30vw] lg:h-[100vh]"> 
        <div className="lg:h-[60rem] flex flex-col items-center justify-center">
      ...
      <div className="flex flex-col items-center justify-center w-[100vw] lg:h-[100vh] bg-gray-200 items-start p-4 justify-start lg:overflow-y-scroll overflow-x-hidden h-fit lg:w-[70vw] align-middle flex-col border-l-4 border-red-900">
