...
export default function Home() {
  return (
    <main className="flex lg:flex-row flex-col overflow-x-hidden overflow-y-scroll lg:overflow-hidden w-[90vw] mx-auto h-[100vh my-auto]">
      <div className="flex flex-col bg-gray-700 lg:bg-gray-100 justify-start items-center py-4 px-4 border-l-4 border-red-900 lg:w-[30vw] lg:h-[90vh]"> 

        <div className="flex    lg:mt-[2rem] mx-auto w-[30rem] h-[25rem] " >
      ...
      <div className="flex flex-col w-[100vw] lg:h-[90vh] bg-gray-200 items-start p-4 justify-start lg:overflow-y-scroll overflow-x-hidden  lg:w-[70vw] lg:h-[90vh] align-middle flex-col border-l-4 border-red-900">
        <div className="flex flex-col gap-4 p-[1rem] w-[55vw] mx-auto">
...
<p className="text-center text-2xl text-yellow-100">Firebase</p>
      ...
      <div className="flex flex-col gap-4 p-4  z-[999] border border-white shadow-lg shadow-yellow-600 rounded-lg w-[55vw] mx-auto mx-auto " > 
