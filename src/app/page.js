...
export default function Home() {
  return (
    <main className="flex lg:flex-row flex-col overflow-x-hidden overflow-y-scroll lg:overflow-hidden w-[100vw] md:w-[100vw] lg:w-[80vw] mx-auto">
      <div className="flex flex-col bg-gray-700 lg:bg-gray-100 justify-start items-center py-4 px-4 border-l-4 border-red-900 w-[20%]"> 
      ...
      <div className="flex w-[80%] lg:w-[60rem] h-[60rem] bg-gray-200 items-start p-4 justify-start lg:overflow-y-scroll overflow-x-hidden h-[100vh] align-middle flex-col border-l-4 border-red-900">
